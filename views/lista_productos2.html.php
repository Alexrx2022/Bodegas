...
<div class="table-product">
            ...
            <tbody>
                ...
                foreach ($productos as $producto): ?>
                    <tr  <?php if($producto->amount <=5){
                        ...
                        <td class="modify"><a role="button"  name="edit"  id="editProduct"
                         class="bfix <?php if($producto->estado != 0 && $producto->estado != null ){
                                    echo 'sin-cursor';
                        } ?>" href="/edit/product?id=<?=  $producto->id ?? 'vacio' ?>&bodega=2" role="button">
                                Editar
                            </a></td>
                        <!-- <td class="delete"><a name="id" id="" class="bdelete"  role="button">
                                Eliminar
                            </a></td> -->
    ...
    <!-- <details>
        <summary>CSS</summary>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maxime, quisquam.</p>
    </details> -->
